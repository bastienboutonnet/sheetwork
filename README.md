...
[![Actions Status](https://github.com/bastienboutonnet/sheetload/workflows/{workflow_name}/badge.svg)](https://github.com/bastienboutonnet/sheetload/actions)

Package Version: `v0.2.1b1`
...
4. Install Sheetload
```bash
pip install git+ssh://git@github.com/bastienboutonnet/sheetload.git@v0.2.1b1
```
